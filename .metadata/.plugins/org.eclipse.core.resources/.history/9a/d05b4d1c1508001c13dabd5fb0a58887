...
int main(void)
{
	...
	do
	{
		...
		printf("Ingrese edad mayor de 17 años: ");
		scanf("%d",&edad);
	...
	printf("a) La cantidad de personas con estado viudo de más de 60 años es de: %d\n",cantidadViudos);
	printf("b) el número de cliente de la mujer mas joven es %d y su edad es de %d\n",numeroDeLaMasJoven,laMasJoven);
